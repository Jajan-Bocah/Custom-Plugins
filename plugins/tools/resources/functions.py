...
from userge.utils.tools import runcmd, take_screen_shot
...
async def media_to_image(message):
    ...
    if replied.sticker and replied.sticker.file_name.endswith(".tgs"):
        ...
        png_file = os.path.join(config.Dynamic.DOWN_PATH, "image.png")
        ...
        stkr_file = os.path.join(config.Dynamic.DOWN_PATH, "stkr.png")
        ...
        jpg_file = os.path.join(config.Dynamic.DOWN_PATH, "image.jpg")
        ...
        jpg_file = os.path.join(config.Dynamic.DOWN_PATH, "image.jpg")
        song_file = os.path.join(config.Dynamic.DOWN_PATH, "song.mp3")
