...
from userge.plugins.misc.upload.uploader import get_thumb, remove_thumb
...
@userge.on_cmd("igdl", about={
    ...
    'usage': "{tr}igdl [flag] [link|username]",
    'examples': [
        "{tr}igdl https://www.instagram.com/××××××××××/",
        "{tr}igdl https://www.instagram.com/×××××××××/igshid=×××××/",
        "{tr}igdl -u [username] -l3",
        "{tr}igdl -u instagram"]})
